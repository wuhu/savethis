...
# TODO: drop python 3.7 support (this is a potential source of bugs)
...
def get_source_segment(source, node):  # TODO: drop python 3.7 support
...
def get_position(source, node):  # TODO: drop python 3.7 support
